...
<body data-spy="scroll" data-target="#navbar-menu">
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBRU4fcRkOZQCcD85ZL8ChsHZIHBNCS2U4&callback=initMap"></script>

    <script src="javascript8/js-google.js"></script>
     <script>
		...
		window.onclick = function(event) {
         ...
         //AJAX ZA KANTU
         //******************************************************************************
        setInterval(updateTrashLevel, 300);

        var procenatGlavnogKontenjera=0;
        function updateTrashLevel() {
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    //alert(this.responseText);
                    procenatGlavnogKontenjera=this.responseText;
                }
            };
